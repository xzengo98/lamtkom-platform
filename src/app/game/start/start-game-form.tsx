  ...
  return (
    ...
    >
      ...
      <section className="relative overflow-hidden rounded-[2.4rem] border border-white/10 bg-[linear-gradient(160deg,rgba(7,16,37,0.98)_0%,rgba(4,10,26,0.99)_52%,rgba(6,15,35,0.98)_100%)] shadow-[0_30px_90px_rgba(0,0,0,0.34)]">
        ...
        <div className="pointer-events-none absolute -top-14 right-12 h-56 w-56 rounded-full bg-cyan-500/12 blur-3xl" />
        <div className="pointer-events-none absolute bottom-0 left-0 h-48 w-56 rounded-full bg-violet-500/10 blur-3xl" />
        <div className="pointer-events-none absolute bottom-10 left-1/2 h-32 w-72 -translate-x-1/2 rounded-full bg-orange-500/10 blur-3xl" />

        <div className="relative grid gap-8 px-5 py-8 md:px-8 md:py-10 xl:grid-cols-[minmax(0,1fr)_300px] xl:items-center xl:gap-12">
          <div className="order-2 text-right xl:order-1">
            ...
            <h1 className="text-3xl font-black leading-[1.08] text-white sm:text-4xl xl:text-6xl">
              جهّز الجولة
              <span className="mt-2 block bg-gradient-to-l from-cyan-300 via-white to-cyan-300 bg-clip-text text-transparent drop-shadow-[0_10px_30px_rgba(34,211,238,0.12)]">
                قبل البدء
              </span>
            </h1>
          ...
          <div className="order-1 flex justify-center xl:order-2 xl:justify-end">
            <div className="relative flex h-[220px] w-[220px] items-center justify-center overflow-hidden rounded-[2.1rem] border border-cyan-400/14 bg-[linear-gradient(160deg,rgba(11,23,49,0.98)_0%,rgba(6,12,28,0.99)_100%)] shadow-[0_26px_70px_rgba(0,0,0,0.40)] sm:h-[250px] sm:w-[250px] xl:h-[270px] xl:w-[270px]">
              ...
              <div className="pointer-events-none absolute inset-[16px] rounded-[1.7rem] border border-white/6" />
              <img
                src={heroLogo}
                alt="شعار لمتكم"
                className="relative h-[145px] w-[145px] object-contain drop-shadow-[0_0_28px_rgba(34,211,238,0.18)] sm:h-[175px] sm:w-[175px] xl:h-[190px] xl:w-[190px]"
                decoding="async"
              />
            </div>
          </div>
      ...
      <section className="rounded-[2rem] border border-white/10 bg-[linear-gradient(160deg,rgba(12,22,45,0.96)_0%,rgba(6,12,28,0.99)_100%)] p-5 shadow-[0_22px_55px_rgba(0,0,0,0.24)] md:p-6">
        <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm leading-7 text-white/50">
              اختر اسمًا للجولة وحدد أسماء الفريقين قبل المتابعة لاختيار الفئات.
            </p>
          </div>

          <div className="rounded-2xl border border-white/8 bg-white/[0.04] px-4 py-2.5 text-xs font-bold text-white/45">
            ابدأ بعد اكتمال {REQUIRED_CATEGORY_COUNT} فئات
          </div>
        </div>

        <div className="mb-6 overflow-hidden rounded-full bg-white/5" style={{ height: 5 }}>
          <div
        ...
        <div className="grid gap-4 xl:grid-cols-3">
          <div className="xl:col-span-1">
            <div className="rounded-[1.6rem] border border-cyan-400/12 bg-[linear-gradient(180deg,rgba(10,23,48,0.96)_0%,rgba(8,16,34,0.98)_100%)] p-3 shadow-[0_14px_36px_rgba(0,0,0,0.16)]">
              <div className="mb-2 flex items-center justify-between gap-3">
                <label className="text-sm font-black text-white">اسم اللعبة</label>
                <span className="rounded-full border border-cyan-400/15 bg-cyan-400/10 px-3 py-1 text-[11px] font-black text-cyan-300">
                  الجولة
                </span>
              </div>
              <input
